...
export async function SearchPageView({
  ...
  return (
    <main
      id="main-content"
      data-testid="search-page-main"
      data-empty-state={query.length < 2 ? "true" : "false"}
      ...
      <section className="overflow-hidden rounded-[2rem] border border-[#5F578E] bg-[linear-gradient(135deg,#2D284A_0%,#3E3762_46%,#4A4476_100%)] px-6 py-5 text-white shadow-[0_20px_48px_rgba(25,18,46,0.28)] sm:px-8 sm:py-6">
        ...
        <form action="/search" className="mt-5 flex flex-col gap-3 sm:flex-row">
          <Input
            ...
            autoComplete="off"
            spellCheck={false}
            className="h-12 flex-1 rounded-2xl border-white/25 bg-white/95 px-4 text-sm text-slate-900 placeholder:text-slate-500 focus-visible:border-white focus-visible:ring-white/30"
