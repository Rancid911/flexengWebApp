...
import { CookieConsentBanner } from "./main/cookie-consent-banner";
import { BenefitsRotator } from "./main/benefits-rotator";
import { HeroLeadModal } from "./main/hero-lead-modal";
import { LeadForm } from "./main/lead-form";
...
import { ReviewsSlider } from "./main/reviews-slider";
...
export default function MainPage() {
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#F8F7FC_0%,#F5F4FA_48%,#F3F1F8_100%)] text-[#322F55]">
        ...
        <div className="relative mx-auto grid w-full max-w-6xl gap-8 px-4 pb-20 pt-10 sm:px-6 sm:pb-24 sm:pt-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:px-8 lg:py-32">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-lg text-[#D9D4F2]">
      ...
      <section id="how-it-works" className="relative">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
          <div className="mb-8 space-y-2">
            <h2 className="text-3xl font-bold tracking-tight text-[#322F55]">Как проходит обучение</h2>
            <p className="text-[#706E88]">Прозрачный маршрут от первой встречи до устойчивого результата.</p>
          </div>
      ...
      <section id="programs" className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="mb-8 space-y-2">
          <h2 className="text-3xl font-bold tracking-tight text-[#322F55]">Программы под разные цели</h2>
          <p className="text-[#706E88]">Выберите направление и уровень, который нужен именно вам.</p>
        </div>
      ...
      <section className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="mb-8 space-y-2">
          <h2 className="text-3xl font-bold tracking-tight text-[#322F55]">Почему такой формат даёт результат</h2>
          <p className="text-[#706E88]">Мы выстроили обучение так, чтобы вы стабильно двигались к цели и видели прогресс по шагам.</p>
        </div>
      ...
      <section id="teachers" className="relative">
        <div className="mx-auto grid w-full max-w-6xl gap-6 px-4 py-14 sm:px-6 lg:grid-cols-[1fr_1fr] lg:px-8">
          <div className="space-y-3 rounded-3xl bg-[linear-gradient(145deg,#EEE8FF_0%,#F4F1FA_100%)] p-6">
            <h2 className="text-3xl font-bold tracking-tight text-[#322F55]">Преподаватели и контроль качества</h2>
            <p className="text-[#706E88]">
      ...
      <section id="reviews" className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="rounded-[28px] border border-[#5E558F] bg-[linear-gradient(160deg,#433A6A_0%,#4F467D_45%,#3D355F_100%)] px-6 py-8 shadow-[0_20px_48px_rgba(34,24,63,0.28)] sm:px-8 sm:py-10">
          <div className="mb-8 space-y-2">
            <h2 className="text-3xl font-bold tracking-tight text-[#F6F2FF]">Отзывы учеников</h2>
            <p className="text-[#D6CFF2]">Реальные результаты, которые достигаются через системную практику.</p>
          </div>
      ...
      <section id="faq" className="relative">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
          <div className="mb-8 space-y-2">
            <h2 className="text-3xl font-bold tracking-tight text-[#322F55]">Часто задаваемые вопросы</h2>
            <p className="text-[#706E88]">Короткие ответы на основные вопросы перед стартом.</p>
          </div>
      ...
      <section aria-label="Переход к заявке" className="relative">
        <div className="mx-auto w-full max-w-6xl px-4 pb-2 sm:px-6 lg:px-8">
          <div className="overflow-hidden rounded-2xl border border-[#6B629A] bg-[radial-gradient(circle_at_top_right,rgba(141,112,255,0.35)_0%,transparent_50%),radial-gradient(circle_at_bottom_left,rgba(247,109,99,0.16)_0%,transparent_42%),linear-gradient(135deg,#2F294D_0%,#3E3762_48%,#4E477A_100%)] px-5 py-5 shadow-[0_14px_36px_rgba(37,27,67,0.26)] sm:px-6 sm:py-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-[#DAD3F3]">
