...
> Historical document. This is not current runtime truth. Use `docs/README.md` and current SQL smoke/runbook documentation before relying on dated performance findings.
