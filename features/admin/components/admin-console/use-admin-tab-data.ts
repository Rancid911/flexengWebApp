...
import { buildAdminTabAdapters } from "@/features/admin/components/admin-console/admin-tab-registry";
import { useAdminQuerySync } from "@/features/admin/components/admin-console/use-admin-query-sync";
import {
...
import { useAdminPaginatedResource } from "@/features/admin/components/admin-console/use-admin-paginated-resource";
import { useAdminBlogMeta } from "@/features/admin/components/admin-console/use-admin-blog-meta";
