...
import type { loadAdminTeacherProfilePageData } from "@/lib/admin/teacher-profile";
...
type AdminTeacherProfilePageData = NonNullable<Awaited<ReturnType<typeof loadAdminTeacherProfilePageData>>>;
          ...
          <div className="rounded-2xl border border-white/15 bg-white/10 p-4 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]">
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <AvatarFallback className="border-white/25 bg-white/20 text-lg font-black text-white">{initials}</AvatarFallback>
              </Avatar>
...
export function AdminTeacherProfileView({ pageData }: { pageData: AdminTeacherProfilePageData }) {
