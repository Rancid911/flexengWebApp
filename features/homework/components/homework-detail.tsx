...
import type { getHomeworkAssignmentDetail } from "@/lib/homework/queries";

type HomeworkAssignmentDetail = NonNullable<Awaited<ReturnType<typeof getHomeworkAssignmentDetail>>>;
...
export function HomeworkDetail({ assignment }: { assignment: HomeworkAssignmentDetail }) {
