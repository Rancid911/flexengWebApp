...
import { useAdminDashboardMetrics } from "@/features/dashboard/client/use-admin-dashboard-metrics";
...
type AdminDashboardViewProps = {
  initialMetrics?: AdminDashboardMetricsDto | null;
};

export default function AdminDashboardView({ initialMetrics = null }: AdminDashboardViewProps) {
