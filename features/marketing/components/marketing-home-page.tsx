...
import { BenefitsRotator } from "@/features/marketing/components/benefits-rotator";
...
import { ReviewsSlider } from "@/features/marketing/components/reviews-slider";
  ...
  return (
    <main className="text-[#322F55]">
      ...
      <section id="how-it-works" className="relative">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
          <div className="mb-8 space-y-2">
            <h2 className="content-heading-balance text-3xl font-bold tracking-tight text-[#322F55]">Как проходит обучение</h2>
      ...
      <section id="programs" className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="mb-8 space-y-2">
          <h2 className="content-heading-balance text-3xl font-bold tracking-tight text-[#322F55]">Программы под разные цели</h2>
      ...
      <section className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="mb-8 space-y-2">
          <h2 className="content-heading-balance text-3xl font-bold tracking-tight text-[#322F55]">Почему такой формат даёт результат</h2>
      ...
      <section id="reviews" className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="rounded-[28px] border border-[#5E558F] bg-[linear-gradient(160deg,#433A6A_0%,#4F467D_45%,#3D355F_100%)] px-6 py-8 shadow-[0_20px_48px_rgba(34,24,63,0.28)] sm:px-8 sm:py-10">
          <div className="mb-8 space-y-2">
            <h2 className="content-heading-balance text-3xl font-bold tracking-tight text-[#F6F2FF]">Отзывы учеников</h2>
      ...
      <section id="faq" className="relative">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
          <div className="mb-8 space-y-2">
            <h2 className="content-heading-balance text-3xl font-bold tracking-tight text-[#322F55]">Часто задаваемые вопросы</h2>
