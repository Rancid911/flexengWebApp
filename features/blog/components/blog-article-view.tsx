...
import type { getBlogPostBySlug } from "@/lib/blog/public";
import { formatPublicDate } from "@/lib/dates/format-public-date";

type BlogArticle = NonNullable<Awaited<ReturnType<typeof getBlogPostBySlug>>>;

type BlogArticleViewProps = {
  article: BlogArticle;
  related: BlogPostCardDto[];
};

export function BlogArticleView({ article, related }: BlogArticleViewProps) {
  const jsonLd = {
