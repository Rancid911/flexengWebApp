...
import type { getPracticeTopicDetail } from "@/lib/practice/queries";
import { StudentEmptyState, StudentPageHeader, StudentSubnav } from "@/shared/ui/student-page-primitives";

type PracticeTopicDetailPayload = NonNullable<Awaited<ReturnType<typeof getPracticeTopicDetail>>>;
...
export function PracticeTopicDetail({ payload }: { payload: PracticeTopicDetailPayload }) {
  return (
