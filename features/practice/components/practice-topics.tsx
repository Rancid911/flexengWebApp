...
import type { getPracticeTopics } from "@/lib/practice/queries";
import { StudentEmptyState, StudentPageHeader, StudentSubnav } from "@/shared/ui/student-page-primitives";

type PracticeTopics = Awaited<ReturnType<typeof getPracticeTopics>>;
...
export function PracticeTopics({ topics }: { topics: PracticeTopics }) {
  return (
