...
import type { getPracticeRecommended } from "@/lib/practice/queries";
import { StudentEmptyState, StudentPageHeader, StudentSubnav } from "@/shared/ui/student-page-primitives";

type PracticeRecommendedItems = Awaited<ReturnType<typeof getPracticeRecommended>>;

export function PracticeRecommended({ recommended }: { recommended: PracticeRecommendedItems }) {
  return (
