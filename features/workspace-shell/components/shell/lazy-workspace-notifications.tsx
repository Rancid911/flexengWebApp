...
import { fetchNotificationsUnreadSummary, readNotificationsUnreadSummary } from "@/features/workspace-shell/client/dashboard-notifications.api";
import { cn } from "@/lib/utils";

const NotificationsPanel = dynamic(
  () => import("@/features/workspace-shell/components/shell/workspace-notifications-panel").then((module) => module.WorkspaceNotificationsPanel),
  { ssr: false }
);
